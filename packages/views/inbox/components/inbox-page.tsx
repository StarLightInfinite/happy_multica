...
export function InboxPage() {
  ...
  useEffect(() => {
    ...
    markReadMutate(selectedId, {
      onError: () => toast.error(t("inbox", "failedMarkRead")),
    });
  ...
  const handleArchive = (id: string) => {
    ...
    archiveMutation.mutate(id, {
      onError: () => toast.error(t("inbox", "failedArchive")),
    });
  };
  ...
  const handleMarkAllRead = () => {
    markAllReadMutation.mutate(undefined, {
      onError: () => toast.error(t("inbox", "failedMarkAllRead")),
    });
  };
  ...
  const handleArchiveAll = () => {
    ...
    archiveAllMutation.mutate(undefined, {
      onError: () => toast.error(t("inbox", "failedArchiveAll")),
    });
  };
  ...
  const handleArchiveAllRead = () => {
    ...
    archiveAllReadMutation.mutate(undefined, {
      onError: () => toast.error(t("inbox", "failedArchiveRead")),
    });
  };
  ...
  const handleArchiveCompleted = () => {
    ...
    archiveCompletedMutation.mutate(undefined, {
      onError: () => toast.error(t("inbox", "failedArchiveCompleted")),
    });
  };
  ...
  const listHeader = (
    <PageHeader className="justify-between">
      <div className="flex items-center gap-2">
        <h1 className="text-sm font-semibold">{t("inbox", "inbox")}</h1>
        {unreadCount > 0 && (
    ...
    <div className="p-6">
      ...
      {selected.type === "quick_create_failed" && selected.details?.original_prompt && (
        <div className="mt-4 rounded-md border bg-muted/40 p-3">
          <p className="text-xs font-medium text-muted-foreground">{t("inbox", "originalInput")}</p>
